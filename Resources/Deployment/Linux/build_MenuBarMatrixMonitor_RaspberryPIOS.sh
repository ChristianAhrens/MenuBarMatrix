...
chmod +x build_MenuBarMatrixMonitor.sh
./build_MenuBarMatrixMonitor.sh 2
...
##!/bin/sh
#exec Documents/Development/GitHub/MenuBarMatrix/MenuBarMatrixMonitor/Builds/LinuxMakefile/build/MenuBarMatrixMonitor